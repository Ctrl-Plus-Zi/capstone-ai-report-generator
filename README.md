...
| ID             | API 이름                     | 제공 기관             | Base URL                                                             | 주요 데이터                          
|----------------|------------------------------|-----------------------|----------------------------------------------------------------------|--------------------------------------|
| KCISA_CPM_003  | 국립중앙박물관 소장품 검색   | 한국문화정보원(KCISA) | https://api.kcisa.kr/openapi/API_CPM_003/request                    | 국립중앙박물관 소장품 메타데이터     |
| KCISA_CCA_145  | 전시정보(통합)              | 한국문화정보원(KCISA) | https://api.kcisa.kr/openapi/API_CCA_145/request                    | 전시·문화행사 메타데이터            |
| KCISA_CCA_144  | 공연정보(통합)              | 한국문화정보원(KCISA) | https://api.kcisa.kr/openapi/API_CCA_144/request                    | 공연 정보 메타데이터, 기관별 공연 선별      | 
| KMA_ASOS_DAILY | 기상청 ASOS 일자료(일별)     | 기상청(KMA)           | https://apis.data.go.kr/1360000/AsosDalyInfoService/getWthrDataList | 일별 기상 통계, 선택 기간의 일강수량·최고/최저기온 조회                 |
